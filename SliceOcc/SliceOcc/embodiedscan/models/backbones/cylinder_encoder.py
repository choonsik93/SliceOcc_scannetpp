...
class CylinderEncoder_Occ(BaseModule):
    ...
    def __init__(self, grid_size, grid_size_rv=None, in_channels=10, out_channels=256, 
        ...
        '''
        self.pool_xy = SparseMaxPool3d(kernel_size=[1,1,2],
                                              stride=[1,1,2], padding=0)
        self.pool_yz = SparseMaxPool3d(kernel_size=[5,1,1],
                                              stride=[5,1,1], padding=0)
        self.pool_zx = SparseMaxPool3d(kernel_size=[1,5,1],
                                              stride=[1,5,1], padding=0)
        '''
