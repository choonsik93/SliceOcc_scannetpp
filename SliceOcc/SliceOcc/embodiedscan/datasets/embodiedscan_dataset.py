...
if __name__ == "__main__":
    ...
    dataset = EmbodiedScanDataset(data_root='data',
    ...
    dataloader = DataLoader(dataset, batch_size=1, persistent_workers=True, shuffle=True, num_workers=0)
    sample = dataloader.__getitem__(10)
    print(sample)
